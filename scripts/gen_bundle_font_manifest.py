#!/usr/bin/env python3
"""Offline generator for browser/fonts/bundle-fonts.manifest.
...
emits a JSON manifest consumed at runtime by the (later, C++) uniform font
list builder. No OS font enumeration is involved - everything here is derived
straight from the font files themselves.

Usage: python gen_bundle_font_manifest.py
Writes: browser/fonts/bundle-fonts.manifest
"""
...
def main():
    ...
    out_path = os.path.join(fonts_dir, "bundle-fonts.manifest")
